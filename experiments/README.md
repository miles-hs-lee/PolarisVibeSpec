...
>
> So PV's three values now have separate empirical anchors: **framing** (bench-002 — task-dependent), **routing tools** (bench-005 — needs cross-domain hidden links), **documentation** (all benches, agent-independent). See [`bench-003/README.md`](bench-003/README.md) for the experiment that broke the original "agent uses PV" story and [`bench-005/README.md`](bench-005/README.md) for the one that confirms the routing value.
