...
export function runPromote(opts: PromoteOpts = {}): void {
  ...
  // Only consider per-node detail pages — pattern PREFIX-DOMAIN-...md.
  // README.md and per-domain narrative pages (e.g. spec/AUTH.md) are
  // also generated by export-all but aren't node-shaped, so promote
  // skips them rather than treating them as "orphan markdown".
